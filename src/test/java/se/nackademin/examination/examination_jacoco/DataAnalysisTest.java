...
public class DataAnalysisTest {
	...
	public void test_getResultStringNamesAndAge(){
		...
		values.addAll(Arrays.asList("Game", "Sina", "Alavi", "M", "29", "Fortaleza"));
		...
		values.clear();
		values.addAll(Arrays.asList("Play", "Nariman", "Salimi", "F", "45", "Tehran"));
		...
		values.clear();
		values.addAll(Arrays.asList("Play", "Mina", "Salimi", "F", "31", "Tehran"));
		assertEquals (dataAnalysis.getResultStringNamesAndAge(values),"No analysis was performed");


		values.clear();
		values.addAll(Arrays.asList("Play", "Maria", "Nil", "F", "28", "Tehran"));
		assertEquals (dataAnalysis.getResultStringNamesAndAge(values),"No analysis was performed");	
